...
class SaveSlot:
    ...
    def manage_save(self, surface, pos):
        """ PSEUDO CODE """
        ...
        if self.manage == True:
            ...
            if self.button_load.draw(surface, pos):
                pass
                # do something here with save file
            if self.button_delete.draw(surface, pos):
                pass
                # do something here with save file
        if self.frame.draw(surface, pos) and self.snapshot == True:
            self.manage = True
