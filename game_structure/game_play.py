...
from utility.algo_utility import choose_k_point_in_path
from utility.algo_utility import choose_point_in_path
...
class GamePlay:
    ...
    def move_focus_tom(self, ui_grp, frame=25):
        ...
        self.tom_vector = pygame.math.Vector2(-tom_player_x_coord, -tom_player_y_coord)
