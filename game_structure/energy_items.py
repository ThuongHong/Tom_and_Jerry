...
class EnergyItem(pygame.sprite.Sprite):
    def __init__(
        ...
        self.collect_energy_sound = pygame.mixer.Sound(
            join("sounds", "collect_energy_sound.mp3")
        )
        ...
        self.image = pygame.transform.scale(
            self.image, (self.grid_size * 0.8, self.grid_size * 0.8)
        )
    ...
    def update(self, player=None, energy_grp=None, sound_on=True, **kwargs):
        if player:
