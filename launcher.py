...
class Launcher():
    def __init__(self, window_screen):
        ...
        self.button_hint_on = Button(DISPLAY.SCREEN_WIDTH * 0.80, DISPLAY.SCREEN_HEIGHT * 0.92, button_hint_on_img, pygame.mixer.Sound(os.path.join('sounds', 'click.ogg')), 0.25, 0.26)
        self.button_hint_off = Button(DISPLAY.SCREEN_WIDTH * 0.80, DISPLAY.SCREEN_HEIGHT * 0.92, button_hint_off_img, pygame.mixer.Sound(os.path.join('sounds', 'click.ogg')), 0.25, 0.26)
        ...
        self.button_switch_themes = Button(DISPLAY.SCREEN_WIDTH * 0.65, DISPLAY.SCREEN_HEIGHT * 0.92, button_switch_themes_img, pygame.mixer.Sound(os.path.join('sounds', 'click.ogg')), 0.25, 0.26)
