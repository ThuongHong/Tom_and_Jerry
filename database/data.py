...
def leaderboard(mode: str) -> list:
    ...
    if mode.upper() == "PUREEASY":
        board = "pure_easy_leaderboard"
    elif mode.upper() == "PUREMEDIUM":
        board = "pure_medium_leaderboard"
    elif mode.upper() == "PUREHARD":
        board = "pure_hard_leaderboard"
    elif mode.upper() == "ENERGYEASY":
        board = "energy_easy_leaderboard"
    elif mode.upper() == "ENERGYMEDIUM":
        board = "energy_medium_leaderboard"
    elif mode.upper() == "ENERGYHARD":
        board = "energy_hard_leaderboard"
    elif mode.upper() == "INSANEEASY":
        board = "insane_easy_leaderboard"
    elif mode.upper() == "INSANEMEDIUM":
        board = "insane_medium_leaderboard"
    elif mode.upper() == "INSANEHARD":
        board = "insane_hard_leaderboard"
