...
def get_manhattan_distance(fisrt_position: tuple, second_position: tuple):
    ...
    if fisrt_position[0] < second_position[0]:
        bias_distance_right = abs(fisrt_position[0] - second_position[0] - bias_x * 2) + abs(fisrt_position[1] - second_position[1] + bias_y)
        bias_distance_left = abs(fisrt_position[0] - second_position[0] + bias_x * 2) + abs(fisrt_position[1] - second_position[1] + bias_y)
        if bias_distance_left >= 5 or bias_distance_right >= 5:
            ...
            # return 1
        return bias_distance_right if bias_distance_right >= bias_distance_left else bias_distance_left
        ...
        bias_distance_right = abs(fisrt_position[0] - second_position[0] - bias_x) + abs(fisrt_position[1] - second_position[1] - bias_y)
        bias_distance_left = abs(fisrt_position[0] - second_position[0] + bias_x) + abs(fisrt_position[1] - second_position[1] + bias_y)
        if bias_distance_left >= 5 or bias_distance_right >= 5:
            return abs(fisrt_position[0] - second_position[0]) + abs(fisrt_position[1] - second_position[1])
            # return 1
        return bias_distance_right if bias_distance_right >= bias_distance_left else bias_distance_left
