...
while game_menu.running:
    ...
    if game_menu.game_state == 'main menu':
        ...
        game_launcher.reset(maze_size=game_menu.difficulty, spawning=game_menu.spawning, energy=game_menu.energy_mode, insane_mode= True, user_id= game_menu.user_id)
